export default {
  ...
  // CRM Pipelines (holding CRM module — Phase 3 slice 1)
  SET_CRM_PIPELINES_UI_FLAG: 'SET_CRM_PIPELINES_UI_FLAG',
  SET_CRM_PIPELINES: 'SET_CRM_PIPELINES',
  ADD_CRM_PIPELINE: 'ADD_CRM_PIPELINE',
  EDIT_CRM_PIPELINE: 'EDIT_CRM_PIPELINE',
  DELETE_CRM_PIPELINE: 'DELETE_CRM_PIPELINE',

  // CRM Stages (nested under pipelines)
  SET_CRM_STAGES_UI_FLAG: 'SET_CRM_STAGES_UI_FLAG',
  SET_CRM_STAGES: 'SET_CRM_STAGES',
  ADD_CRM_STAGE: 'ADD_CRM_STAGE',
  EDIT_CRM_STAGE: 'EDIT_CRM_STAGE',
  DELETE_CRM_STAGE: 'DELETE_CRM_STAGE',
  REORDER_CRM_STAGES: 'REORDER_CRM_STAGES',

  // CRM Opportunities
  SET_CRM_OPPORTUNITIES_UI_FLAG: 'SET_CRM_OPPORTUNITIES_UI_FLAG',
  SET_CRM_OPPORTUNITIES: 'SET_CRM_OPPORTUNITIES',
  ADD_CRM_OPPORTUNITY: 'ADD_CRM_OPPORTUNITY',
  EDIT_CRM_OPPORTUNITY: 'EDIT_CRM_OPPORTUNITY',
  DELETE_CRM_OPPORTUNITY: 'DELETE_CRM_OPPORTUNITY',
  MOVE_CRM_OPPORTUNITY_TO_STAGE: 'MOVE_CRM_OPPORTUNITY_TO_STAGE',
  DISCARD_CRM_OPPORTUNITY: 'DISCARD_CRM_OPPORTUNITY',
  ...
  // CRM — companies + activities (Phase 4 slice 0)
  // [2026-05-17] Bloco intencionalmente isolado no fim do arquivo pra evitar
  // conflito com PR #16 (Phase 3 slice 1, pipelines/stages/opportunities).
  // Rebase = re-sort destes 11 types ao lado do bloco Phase 3.
  SET_CRM_COMPANIES_UI_FLAG: 'SET_CRM_COMPANIES_UI_FLAG',
  SET_CRM_COMPANIES: 'SET_CRM_COMPANIES',
  ADD_CRM_COMPANY: 'ADD_CRM_COMPANY',
  EDIT_CRM_COMPANY: 'EDIT_CRM_COMPANY',
  DELETE_CRM_COMPANY: 'DELETE_CRM_COMPANY',

  SET_CRM_ACTIVITIES_UI_FLAG: 'SET_CRM_ACTIVITIES_UI_FLAG',
  SET_CRM_ACTIVITIES: 'SET_CRM_ACTIVITIES',
  ADD_CRM_ACTIVITY: 'ADD_CRM_ACTIVITY',
  EDIT_CRM_ACTIVITY: 'EDIT_CRM_ACTIVITY',
  DELETE_CRM_ACTIVITY: 'DELETE_CRM_ACTIVITY',
  COMPLETE_CRM_ACTIVITY: 'COMPLETE_CRM_ACTIVITY',
};
